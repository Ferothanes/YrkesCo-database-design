...
-- each program should have atleast 3 courses attached. 
...
-- Varje utbildningsledare ska vara ansvarig för 3 klasser
-- Vilken utbildningsledare är ansvarig för vilka klasser?
SELECT 
    UL.Fornamn, 
    UL.Efternamn, 
    K.Klassnamn
